...
public class ApplicationDbContext : IdentityDbContext<UserEntity, RoleEntity, Guid>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<ProductTypeEntity>().HasData(
                new ProductTypeEntity { Id = Guid.Parse("4284009c-0956-492e-ba3f-b6b0deed917c"), Name = "Default" },
                new ProductTypeEntity { Id = Guid.Parse("73f168d0-0faa-4005-a0fb-ff875ef8fbd9"), Name = "Paperback" },
                new ProductTypeEntity { Id = Guid.Parse("59178d1e-9a24-4ca7-90c1-ddd4c9d8dd37"), Name = "E-Book" },
                new ProductTypeEntity { Id = Guid.Parse("4c42d2c7-24ee-4e11-8dcf-b44c6d8b2e90"), Name = "Audiobook" },
                new ProductTypeEntity { Id = Guid.Parse("0e576d72-004c-47dc-a778-b1e9579d4893"), Name = "Stream" },
                new ProductTypeEntity { Id = Guid.Parse("ceb89799-0d43-4311-8ed6-65e69eb58f14"), Name = "Blu-ray" },
                new ProductTypeEntity { Id = Guid.Parse("e164e57a-9d08-4d94-abc0-790e75943ba6"), Name = "VHS" },
                new ProductTypeEntity { Id = Guid.Parse("29ce0f37-d821-4afa-9637-e4dedacf79d6"), Name = "PC" },
                new ProductTypeEntity { Id = Guid.Parse("1f07c38f-5600-457c-a64f-8bbaf9b216c5"), Name = "PlayStation" },
                new ProductTypeEntity { Id = Guid.Parse("3ae26458-596b-43dd-a37a-5088ec4921d9"), Name = "Xbox" }
        );
        ...
        builder.Entity<ProductVariantEntity>().HasData(
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("8f6f4d09-4292-48cc-a8bf-76e7fe0bb961"),
                ProductTypeId = Guid.Parse("73f168d0-0faa-4005-a0fb-ff875ef8fbd9"),
                Price = 9.99m,
            ...
            {
                ProductId = Guid.Parse("8f6f4d09-4292-48cc-a8bf-76e7fe0bb961"),
                ProductTypeId = Guid.Parse("59178d1e-9a24-4ca7-90c1-ddd4c9d8dd37"),
                Price = 7.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("8f6f4d09-4292-48cc-a8bf-76e7fe0bb961"),
                ProductTypeId = Guid.Parse("e164e57a-9d08-4d94-abc0-790e75943ba6"),
                Price = 19.99m,
                OriginalPrice = 29.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("e1cee7b3-a6ae-4ae3-bcf4-1955129d8197"),
                ProductTypeId = Guid.Parse("73f168d0-0faa-4005-a0fb-ff875ef8fbd9"),
                Price = 7.99m,
            ...
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("772bc058-2e46-4d3f-ac02-3dd4a6a5aced"),
                ProductTypeId = Guid.Parse("73f168d0-0faa-4005-a0fb-ff875ef8fbd9"),
                Price = 6.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("71b5e16d-7c46-41b8-9b5a-cb00376c4b60"),
                ProductTypeId = Guid.Parse("0e576d72-004c-47dc-a778-b1e9579d4893"),
                Price = 3.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("71b5e16d-7c46-41b8-9b5a-cb00376c4b60"),
                ProductTypeId = Guid.Parse("ceb89799-0d43-4311-8ed6-65e69eb58f14"),
                Price = 9.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("71b5e16d-7c46-41b8-9b5a-cb00376c4b60"),
                ProductTypeId = Guid.Parse("4c42d2c7-24ee-4e11-8dcf-b44c6d8b2e90"),
                Price = 19.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("0e7f6b60-6e98-4220-93ea-45f64e0f1aa2"),
                ProductTypeId = Guid.Parse("0e576d72-004c-47dc-a778-b1e9579d4893"),
                Price = 3.99m,
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("913f130b-c1b6-4a98-8d63-4cf316da3fc1"),
                ProductTypeId = Guid.Parse("0e576d72-004c-47dc-a778-b1e9579d4893"),
                Price = 2.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("453f44f7-e33e-4477-a2ad-a78e232db482"),
                ProductTypeId = Guid.Parse("29ce0f37-d821-4afa-9637-e4dedacf79d6"),
                Price = 19.99m,
                OriginalPrice = 29.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("453f44f7-e33e-4477-a2ad-a78e232db482"),
                ProductTypeId = Guid.Parse("1f07c38f-5600-457c-a64f-8bbaf9b216c5"),
                Price = 69.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("453f44f7-e33e-4477-a2ad-a78e232db482"),
                ProductTypeId = Guid.Parse("3ae26458-596b-43dd-a37a-5088ec4921d9"),
                Price = 49.99m,
                OriginalPrice = 59.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("5cda1ac6-7e1f-4f28-84e9-319455fc7016"),
                ProductTypeId = Guid.Parse("29ce0f37-d821-4afa-9637-e4dedacf79d6"),
                Price = 9.99m,
            ...
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("26429623-f8b1-49de-85a3-57e2c370afcb"),
                ProductTypeId = Guid.Parse("29ce0f37-d821-4afa-9637-e4dedacf79d6"),
                Price = 14.99m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("ff619bfc-5866-4a5b-9a95-9a8a0e457c91"),
                ProductTypeId = Guid.Parse("4284009c-0956-492e-ba3f-b6b0deed917c"),
                Price = 159.99m,
                OriginalPrice = 299m
            },
            new ProductVariantEntity
            {
                ProductId = Guid.Parse("285a8637-e594-4729-b408-67819bb3e3e9"),
                ProductTypeId = Guid.Parse("4284009c-0956-492e-ba3f-b6b0deed917c"),
                Price = 79.99m,
                OriginalPrice = 399m
            }
